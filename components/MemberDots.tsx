...
const MEMBERS = [
  { name: "Hongjoong", initials: "HJ", color: "#FF6B35", secondColor: "#FF9A6C", role: "Leader · Rapper · Producer", type: "LEADER",    birthdate: "Nov 7, 1998",  height: "175 cm", mbti: "INFJ", age: 27, image: "/members/hongjoong.jpg", fact: "Writes & produces most of ATEEZ's music — a true creative force.",                rarity: "LEGENDARY" as const, power: 90, stage: 95, vocal: 82, dance: 90 },
  { name: "Seonghwa",  initials: "SH", color: "#B48EE0", secondColor: "#D8B4FE", role: "Visual · Vocalist",           type: "VISUAL",   birthdate: "Apr 3, 1998",  height: "179 cm", mbti: "ISFJ", age: 27, image: "/members/seonghwa.jpg",  fact: "Known as ATEEZ's 'mom' — the most caring member of the group.",                 rarity: "LEGENDARY" as const, power: 94, stage: 95, vocal: 92, dance: 92 },
  { name: "Yunho",     initials: "YH", color: "#4FC3F7", secondColor: "#BAE6FD", role: "Main Dancer · Vocalist",      type: "DANCER",   birthdate: "Mar 23, 1999", height: "187 cm", mbti: "ENFJ", age: 26, image: "/members/yunho.jpg",     fact: "At 187cm, his body rolls and fluid movement defy physics.",                     rarity: "LEGENDARY" as const, power: 92, stage: 93, vocal: 90, dance: 96 },
  { name: "Yeosang",   initials: "YS", color: "#81C784", secondColor: "#BBF7D0", role: "Vocalist · Dancer",           type: "VOCALIST", birthdate: "Jun 15, 1999", height: "175 cm", mbti: "INFP", age: 26, image: "/members/yeosang.jpg",   fact: "Trained at Big Hit alongside BTS's V before joining KQ.",                       rarity: "LEGENDARY" as const, power: 93, stage: 90, vocal: 90, dance: 90 },
  { name: "San",       initials: "SN", color: "#F06292", secondColor: "#FBCFE8", role: "Main Dancer · Vocalist",      type: "PERFORMER",birthdate: "Jul 10, 1999", height: "176 cm", mbti: "ENFP", age: 26, image: "/members/san.jpg",       fact: "His stage eye contact is so intense it became a fandom legend.",                rarity: "LEGENDARY" as const, power: 97, stage: 99, vocal: 94, dance: 97 },
  { name: "Mingi",     initials: "MG", color: "#FFD54F", secondColor: "#FEF08A", role: "Main Rapper · Dancer",        type: "RAPPER",   birthdate: "Aug 9, 1999",  height: "185 cm", mbti: "ENFP", age: 26, image: "/members/mingi.jpg",     fact: "His deep, booming rap voice is one of the most distinctive in K-pop.",          rarity: "LEGENDARY" as const, power: 95, stage: 91, vocal: 84, dance: 90 },
  { name: "Wooyoung",  initials: "WY", color: "#CE93D8", secondColor: "#E9D5FF", role: "Vocalist · Dancer",           type: "VOCALIST", birthdate: "Nov 26, 1999", height: "172 cm", mbti: "ESFP", age: 26, image: "/members/wooyoung.jpg",  fact: "Has been best friends with BTS's Jimin since their school days.",               rarity: "LEGENDARY" as const, power: 90, stage: 92, vocal: 90, dance: 91 },
  { name: "Jongho",    initials: "JH", color: "#4DD0E1", secondColor: "#A5F3FC", role: "Main Vocalist",               type: "VOCALIST", birthdate: "Oct 12, 2000", height: "173 cm", mbti: "ISTJ", age: 25, image: "/members/jongho.jpg",    fact: "Breaks apples with his bare hands. Also has the most powerful 4th-gen vocals.", rarity: "LEGENDARY" as const, power: 92, stage: 90, vocal: 99, dance: 90 },
]
    ...
    <div style={{ width: 280, borderRadius: 20, overflow: "hidden", background: "linear-gradient(160deg,#111827,#0d1117)", border: `2px solid ${isBias ? rarity.border : rarity.border+"88"}`, boxShadow: isBias ? `0 0 0 2px ${rarity.border},0 0 30px ${rarity.glow},0 0 60px ${member.color}22,0 24px 60px rgba(0,0,0,.7)` : `0 0 20px ${rarity.glow},0 24px 60px rgba(0,0,0,.7)` }}>
      ...
      <div style={{ padding: 12 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 5, marginBottom: 8 }}>
          {[{l:"HEIGHT",v:member.height},{l:"MBTI",v:member.mbti}].map(({l,v}) => (
