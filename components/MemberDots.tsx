...
const MEMBERS = [
  { name: "Hongjoong", initials: "HJ", color: "#FF6B35", secondColor: "#FF9A6C", role: "Leader · Rapper · Producer", type: "LEADER",    birthdate: "Nov 7, 1998",  height: "172 cm", mbti: "INFP", age: 27, image: "/members/hongjoong.jpg", fact: "Hates greens.  Loves minions.",                                                 rarity: "LEGENDARY" as const, power: 1024, stage: 95, vocal: 82, dance: 90 },
  { name: "Seonghwa",  initials: "SH", color: "#B48EE0", secondColor: "#D8B4FE", role: "Visual · Vocalist",           type: "VISUAL",   birthdate: "Apr 3, 1998",  height: "178 cm", mbti: "ENFJ", age: 27, image: "/members/seonghwa.jpg",  fact: "Prone to small bouts of (harmless) violence.",                                  rarity: "LEGENDARY" as const, power: 1024, stage: 95, vocal: 92, dance: 92 },
  { name: "Yunho",     initials: "YH", color: "#4FC3F7", secondColor: "#BAE6FD", role: "Main Dancer · Vocalist",      type: "DANCER",   birthdate: "Mar 23, 1999", height: "186 cm", mbti: "ENFJ", age: 26, image: "/members/yunho.jpg",     fact: "Gets away with anything because hes handsome and cute.",                        rarity: "LEGENDARY" as const, power: 1024, stage: 93, vocal: 90, dance: 96 },
  { name: "Yeosang",   initials: "YS", color: "#81C784", secondColor: "#BBF7D0", role: "Vocalist · Dancer",           type: "VOCALIST", birthdate: "Jun 15, 1999", height: "175 cm", mbti: "ISFJ", age: 26, image: "/members/yeosang.jpg",   fact: "Superpower: hehet. Allegedly a doberman, occasionally resembles a maltese.",    rarity: "LEGENDARY" as const, power: 1024, stage: 90, vocal: 90, dance: 90 },
  { name: "San",       initials: "SN", color: "#F06292", secondColor: "#FBCFE8", role: "Main Dancer · Vocalist",      type: "PERFORMER",birthdate: "Jul 10, 1999", height: "177 cm", mbti: "INFP", age: 26, image: "/members/san.jpg",       fact: "WILL break the stage (metaphorically)... and 10 headsets (literally).",         rarity: "LEGENDARY" as const, power: 1024, stage: 99, vocal: 94, dance: 97 },
  { name: "Mingi",     initials: "MG", color: "#FFD54F", secondColor: "#FEF08A", role: "Main Rapper · Dancer",        type: "RAPPER",   birthdate: "Aug 9, 1999",  height: "184 cm", mbti: "INFP", age: 26, image: "/members/mingi.jpg",     fact: "CAUTION: Will mesmerise you with his hips and disarm you with cuteness.",       rarity: "LEGENDARY" as const, power: 1024, stage: 91, vocal: 84, dance: 90 },
  { name: "Wooyoung",  initials: "WY", color: "#CE93D8", secondColor: "#E9D5FF", role: "Vocalist · Dancer",           type: "VOCALIST", birthdate: "Nov 26, 1999", height: "173 cm", mbti: "ESFJ", age: 26, image: "/members/wooyoung.jpg",  fact: "He may bite. May also hiss.",                                                   rarity: "LEGENDARY" as const, power: 1024, stage: 92, vocal: 90, dance: 91 },
  { name: "Jongho",    initials: "JH", color: "#4DD0E1", secondColor: "#A5F3FC", role: "Main Vocalist",               type: "VOCALIST", birthdate: "Oct 12, 2000", height: "176 cm", mbti: "ISFP", age: 25, image: "/members/jongho.jpg",    fact: "Will seranade you beautifully to distract you from the fact that hes selling you out for 10 dollars.", rarity: "LEGENDARY" as const, power: 1024, stage: 90, vocal: 99, dance: 90 },
]
    ...
    <div style={{ width: 280, borderRadius: 20, overflow: "hidden", background: "linear-gradient(160deg,#111827,#0d1117)", border: `2px solid ${isBias ? rarity.border : rarity.border+"88"}`, boxShadow: isBias ? `0 0 0 2px ${rarity.border},0 0 30px ${rarity.glow},0 0 60px ${member.color}22,0 24px 60px rgba(0,0,0,.7)` : `0 0 20px ${rarity.glow},0 24px 60px rgba(0,0,0,.7)` }}>
      ...
      <div style={{ padding: 12 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 5, marginBottom: 8 }}>
          {[{l:"HEIGHT",v:member.height},{l:"MBTI",v:member.mbti}, {l:"AGE",v:member.age}].map(({l,v}) => (
...
function FlipCard({ member, isBias, onClose }: { member: Member; isBias: boolean; onClose: () => void }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,.82)", backdropFilter: "blur(4px)", padding: 16 }} onClick={onClose}>
      <div style={{ position: "absolute", width: 300, height: 300, borderRadius: "50%", background: `${member.color}18`, filter: "blur(60px)", pointerEvents: "none" }} />
      <div onClick={e => { e.stopPropagation(); setFlipped(f => !f) }} style={{ perspective: 1200, cursor: "pointer", zIndex: 1 }}>
