...
const COLLECTIONS: Collection[] = [
    ...
    id: "ghp5-concept",
    name: "Concept Photos",
    groupLabel: "GOLDEN HOUR Pt.5",
    groupId: "ghp5",
    rarity: "common",
    pool: "general",
    folder: "photocards/golden-hour-pt5",
    cardCounts: { hj: 2, sh: 2, yh: 2, ys: 2, sn: 2, mg: 2, wy: 2, jh: 2 },
  },
  {
    id: "ghp4-concept",
    name: "Concept Photos",
  ...
  },
  {
    ...
    rarity: "rare",
    pool: "general",
    folder: "photocards/ghp4-polaroids",
    cardCounts: { hj: 1, sh: 1, yh: 1, ys: 1, sn: 1, mg: 1, wy: 1, jh: 1 },
  },
      {
    id: "ghp4-soundwave",
